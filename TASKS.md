...
3. [DONE] **ExtendScript: monotonic runs -> smooth interior keys.** Now temporal auto-bezier via typed jsx functions in [aeft.ts](src/jsx/aeft/aeft.ts) (dot-product rule for spatial properties, per-dimension direction test otherwise).
